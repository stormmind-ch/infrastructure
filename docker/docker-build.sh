...
docker build -t proxy-test ../../../new-infra/infrastructure/docker/nginx/Dockerfile
docker tag proxy-test stormmind/proxy-test
docker push stormmind/proxy-test

docker build -t frontend-test ../../../new-frontend/frontend/Dockerfile
docker tag frontend-test stormmind/frontend-test
docker push stormmind/frontend-test

docker build -t backend-test ../../../new-backend/backend/Dockerfile
